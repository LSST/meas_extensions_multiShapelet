...
void FitPsfAlgorithm::fitShapeletTerms(
    ...
    shapelet::MatrixBuilder<double> innerBuilder =
        shapelet::MatrixBuilder<double>::Factory(inputs.getX(), inputs.getY(), ctrl.innerOrder)();
    shapelet::MatrixBuilder<double> outerBuilder =
        shapelet::MatrixBuilder<double>::Factory(inputs.getX(), inputs.getY(), ctrl.outerOrder)();
